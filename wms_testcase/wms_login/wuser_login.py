...
class WuserLogin(unittest.TestCase):
    ...
    # OMS登录接口
    def test_wuser_login_normal(self):
        # 1.读取该测试类所有用例数据
        self.data_list = excel_to_list("../xls/测试用例数据.xls", "WMS登录")
        ...
        for i in range(0, length):
            ...
            session = case_data.get('x-access-token')
